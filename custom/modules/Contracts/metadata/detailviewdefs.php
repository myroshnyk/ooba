    ...
    array (
      ...
      array (
        ...
        array (
          ...
          1 => 'DUPLICATE',
          2 => 'DELETE',
          //btn 'Create Bond Opportunity'
          array (
                'customCode' => '<input title="Create Bond Opportunity" class="button" onclick="this.form.return_module.value=\'Contracts\'; this.form.return_id.value=\'{$fields.id.value}\'; this.form.action.value=\'PrequalificationConvertToBondService\'; " type="submit" name="rls_create_bond_opportunity" value="Create Bond Opportunity" id="rls_create_bond_opportunity">',
          ),
        ),
      ),
      'useTabs' => false,
