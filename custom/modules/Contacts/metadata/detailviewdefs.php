    ...
    array (
      ...
      array (
        ...
        array (
          ...
          7 => 
          array (
            'customCode' => '<input title="Credit Check" class="button" onclick="this.form.return_module.value=\'Contacts\'; this.form.return_id.value=\'{$fields.id.value}\'; this.form.action.value=\'CreditCheck\'; " type="submit" name="rls_credit_check" value="Credit Check" id="rls_credit_check">',
          ),
        ),
      ),
      'maxColumns' => '2',
