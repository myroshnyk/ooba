    ...
    array (
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'label' => 'LBL_INTEREST_RATE_C',
          ),
          1 => 
          array (
            'name' => 'loan_term_c',
            'studio' => 'visible',
            'label' => 'LBL_LOAN_TERM_C',
          ),
        ),
        3 => 
        array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            'name' => 'total_gross_income_c',
            'label' => 'LBL_TOTAL_GROSS_INCOME_C',
          ),
          1 => 
          array (
            'name' => 'total_nett_disposable_inco_c',
            'label' => 'LBL_TOTAL_NETT_DISPOSABLE_INCO_C',
          ),
        ),
      ),
      'LBL_PANEL_ASSIGNMENT' => 
