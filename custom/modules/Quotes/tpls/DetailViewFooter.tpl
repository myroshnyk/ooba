...
<tr>
	...
	<td scope="row" width="1%" valign="top" style="text-align: left;" colspan='3'>{$MOD.LBL_BUNDLE_NAME}&nbsp;<b>{$BUNDLE_NAME}</b></td>
         <td scope="row" width="10%" valign="top" style="text-align: center;"></td>
	...
	<td scope="row" width="1%" valign="top" style="text-align: left;">&nbsp;</td>
        <td scope="row" width="10%" valign="top" style="text-align: center;">Line Item Selection</td>
        ...
        {if $line_item->object_name == "Product"}
			...
			<td width="1" valign="top"style="text-align: center;">{if $bean->show_line_nums == 1}{counter print=true}{/if}&nbsp;</td>
                        <td valign="top" style="text-align: center;">
                         {if $line_item->litem_selection_c==true}
                            <input type="checkbox" disabled="disabled"  value="{$line_item->litem_selection_c}" checked>
                         {else}
                             <input type="checkbox" disabled="disabled"  value="{$line_item->litem_selection_c}">
                         {/if}
                        </td>
