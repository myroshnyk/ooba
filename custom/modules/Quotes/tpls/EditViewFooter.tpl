...
<script type="text/javascript" src="{sugar_getjspath file='custom/modules/Quotes/quotes.js'}"></script>
<script type="text/javascript" src="{sugar_getjspath file='custom/modules/Quotes/EditView.js'}"></script>
