...
//	var form_name = popup_reply_data.form_name;
	...
	quotesManager.lookup_item('description_' + row_id, window.document).value = desc;
        ...
        //
        quotesManager.lookup_item('litem_selection_c_' + row_id, window.document).value = name_to_value_array['litem_selection_c'];
...
function set_after_sqs(sqs_object, sqs_object_id) {
	...
	//document.getElementById('line_item_selection_c_' + row_id).value = sqs_object['line_item_selection_c'];
