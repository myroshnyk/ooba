...
//             
//            $this->bean->ref_number_c=$ref_number;
//        }
  ...
  */
  ...
  function display() {
    ...
    $('#btn_ea_branch_c').removeAttr('onclick');               // EA Branch filtered by Agency
        $('#btn_ea_branch_c').on('click',(function() {            
          ...
          open_popup ("rls01_RealEstateBranches", 600, 400, initialfilter, true, false, {
            ...
            "field_to_name_array": {
              ...
              "rls01_resources_id1_c":"rls01_resources_id4_c",
              "account_manager_kam1_c":"account_manager_kam_c",
       ...
       $("select#product_c").prop('selectedIndex', 1); 
    </script>
EOQ;
